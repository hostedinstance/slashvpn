...
export function Locations() {
  return (
    <AnimatedContent
      ...
      threshold={0.1}
    >
      <div id="locations" style={{ backgroundColor: '#000' }}>
        <CountrySelector
          ...
          activeRowConfig={{ duration: 25, direction: 'left-to-right', gap: 32, paddingY: 20 }}
          ...
          upcomingRowConfig={{ duration: 35, direction: 'right-to-left', gap: 28, paddingY: 20 }}
