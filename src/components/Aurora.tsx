...
export default function AuroraShader({
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uMouse: { value: [0, 0] },
        uFlipVertical: { value: flipVertical ? 1.0 : 0.0 },
      },
    });
    ...
    const animate = (t: number) => {
      ...
      program.uniforms.uFlipVertical.value = flipVertical ? 1.0 : 0.0;
  ...
  }, [amplitude, blend, colorStops, speed, flipVertical]);

  return (
    <div
      ref={containerRef}
      className="absolute bottom-0 left-0 w-full h-[500px] pointer-events-none -z-10"
